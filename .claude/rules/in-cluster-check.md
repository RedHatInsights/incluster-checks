...
5. **Result Aggregation**: `StructedPrinter` collects results and generates output (JSON)
...
- `StructedPrinter` (`core/printer.py`): Result collection, formatting, and output (JSON)
